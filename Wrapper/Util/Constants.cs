...
namespace Wrapper.Util
{
    class Constants
    {
        ...
        public static readonly string injectorPath = Path.Combine(currPath, "Injector.exe");
        public static readonly string payloadPath = Path.Combine(currPath, "Payload.dll");
